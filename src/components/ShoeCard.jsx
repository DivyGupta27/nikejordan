  ...
  return (
    <div className="bg-white w-[350px] h-[500px] flex flex-col shadow-md rounded-2xl overflow-hidden p-6 hover:shadow-2xl transition duration-300">
      ...
      <div className='flex gap-2 mt-auto'>
        <button
          onClick={handleAdd}
          className="mt-4 w-full bg-gray-200 px-4 py-2 cursor-pointer rounded hover:bg-gray-300"
        >
          Add to Cart
        </button>
        <button
          onClick={handleBuy}
          className="mt-4 w-full bg-black text-white px-4 py-2 cursor-pointer rounded hover:bg-gray-800"
        >
          Buy Now
        </button>
      </div>
